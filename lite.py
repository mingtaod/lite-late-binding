...
class roberta_mnli_typing(nn.Module):
    ...
    def forward(self, input_ids, attention_mask):
        ...
        # print("roberta_output.logits.shape: ", roberta_output.logits.shape)
        return res
...
def main():
    ...
    parser.add_argument("--data_dir",
                        type=str,
                        default='/nas/home/mingtaod/codes/lite/data', # Modify the data directory
                        help="The input data directory.")
    parser.add_argument("--output_dir",
                        type=str,
                        default='/nas/home/mingtaod/codes/lite/output/original_lite', # Modify the output directory
    ...
    logging.basicConfig(filename=os.path.join(args.output_dir, 
                        f'batch{args.train_batch_size}_margin{args.margin}' \
                        f'_lr{args.learning_rate}lambda{args.lamb}_{cur_time}_logs.log'),
    ...
    model.to(device)
    logging.info(f'###\nModel Loaded to {torch.cuda.get_device_name(device)}, cuda:4')
