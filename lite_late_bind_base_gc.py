    ...
    for _ in train_iterator:
        ...
        for step, batch in enumerate(epoch_iterator):
            ...
            if args.save_steps != 0 and local_step > 0 and local_step % args.save_steps == 0:
                ...
                # training_details = f'late_bind_MLP_steps{local_step}_{curr_time}'
...
def main():
    ...
    model.to(device)
    logging.info(f'###\nModel Loaded to {torch.cuda.get_device_name(device)}, cuda:0')
    ...
    # figer
    # train_dataset = TypingDataset(os.path.join(args.data_dir, "full_processed.json"), os.path.join(args.data_dir, "compiled_types.txt"))
    # ontonotes
